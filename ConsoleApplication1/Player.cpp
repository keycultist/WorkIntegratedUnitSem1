    ...
    //Simplay OP
        ...
        if (GetPlayerLvl() == 10) {
            if (GetPlayerKarma() > 50) {
                ...
                std::cin >> replaceindex;
                if (replaceindex != 5) {
                    moveset.ReplaceMove(Moveset::Move("Kamehameha", 200, 1, "Magical"), replaceindex - 1);
                }
            }
            else if (GetPlayerKarma() == 50) {
                ...
                std::cin >> replaceindex;
                if (replaceindex != 5) {
                    moveset.ReplaceMove(Moveset::Move("Unlimited Blade Works", 2, 100, "Physical"), replaceindex - 1);
                }
            }
            else if (GetPlayerKarma() < 50) {
                ...
                std::cin >> replaceindex;
                if (replaceindex != 5) {
                    moveset.ReplaceMove(Moveset::Move("Spirit Whisper", 0, 5, "Control"), replaceindex - 1);
                }
            }
        }
    }
